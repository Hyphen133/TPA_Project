...
namespace ViewConsole
{
    class Program
    {
        private static Stack<TreeViewItem> parenting;
        private static TreeViewItem currentElement;
        private static int currentChildValue;
        private static List<List<String>> above;
        private static List<List<String>> below;

        static void Main(string[] args)
        {
            parenting = new Stack<TreeViewItem>();
            MyViewModel myViewModel = new MyViewModel();
            myViewModel.PathVariable = @"C:\Users\hyphe\source\repos\ReflectionApp\ReflectionApp\TPA.ApplicationArchitecture.dll";
